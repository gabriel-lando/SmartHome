...
void SetupWiFi() {
  ...
  bool res;
  wifiManager.setConfigPortalTimeout(300);             // Set AP timeout to 300 seconds = 5 minutes
...
bool CheckWifiStatus() {
  ...
  // Return "true" in case the connection status is WL_CONNECTED
  return (res == WL_CONNECTED);
}
